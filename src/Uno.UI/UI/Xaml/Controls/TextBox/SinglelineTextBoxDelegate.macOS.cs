...
{
	public partial class SinglelineTextBoxDelegate : NSTextFieldDelegate
	{
		...
		//public override bool ShouldChangeCharacters(NSTextField textField, NSRange range, string replacementString)
		//{
