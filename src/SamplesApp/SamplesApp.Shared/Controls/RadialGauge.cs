...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
	...
	public partial class RadialGauge : RangeBase
	{
		...
		public static readonly DependencyProperty ValueStringFormatProperty =
			DependencyProperty.Register(nameof(ValueStringFormat), typeof(string), typeof(RadialGauge), new PropertyMetadata("N0", (DependencyObject s, DependencyPropertyChangedEventArgs e) => OnValueChanged(s)));
		...
		private static void OnFaceChanged(DependencyObject d)
		{
			...
			radialGauge._root = GetVisual(container);
		...
		{
			if (false)//ThemeListener.IsHighContrast)
			{
